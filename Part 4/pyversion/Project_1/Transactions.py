...
class Account:
    ...
    # We have to do that real positive number validation.
    # We'll deal with it in the same we dealt with the name validations,
    # except we won't be storing anything - this is going to be a good candidate for a static method.
    @staticmethod
    ...
    def withdraw(self, value):
        ...
        # for example, if transaction is rejected, we don't want to change the balance
        if accept:
            self._balance -= value
